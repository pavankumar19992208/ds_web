...
import { Typography, Grid, Table, TableBody, TableRow, TableCell, IconButton } from '@mui/material';
              ...
              {formData.documents.map((doc, index) => (
                <React.Fragment key={index}>
                  ...
                  {expandedDoc === index && (
                    <TableRow>
                      <TableCell colSpan={3}>
                        <img src={doc.data} alt="files" style={{ width: '200px', height: '200px', objectFit: 'cover' }} />
                      </TableCell>
                    </TableRow>
                  )}
                </React.Fragment>
